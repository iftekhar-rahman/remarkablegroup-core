...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \Remarkable_Group_Addon\Plugin The single instance of the class.
	 */
	...
	public function my_plugin_frontend_stylesheets() {
		...
		wp_register_style( 'remarkablegroup-addon', plugins_url( '/assets/css/remarkablegroup-addon.css', __FILE__ ) );

		wp_enqueue_style( 'remarkablegroup-addon' );
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/product-table.php' );

		$widgets_manager->register( new \Remarkable_Group_Addon\Product_Table_Post() );
